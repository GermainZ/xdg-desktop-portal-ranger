...
static const char service_name[] = "org.freedesktop.impl.portal.desktop.ranger";

static int xdpw_usage(FILE *stream, int rc) {
    static const char *usage =
        "Usage: xdg-desktop-portal-ranger [options]\n"
        "\n"
        "    -l, --loglevel=<loglevel>        Select log level (default is ERROR).\n"
        "                                     QUIET, ERROR, WARN, INFO, DEBUG, TRACE\n"
        "    -c, --config=<config file>	      Select config file.\n"
        "                                     (default is $XDG_CONFIG_HOME/xdg-desktop-portal-ranger/config)\n"
